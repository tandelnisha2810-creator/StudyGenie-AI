...
// NOTE:
// This route is kept only to avoid breaking imports/routes in existing builds.
// Email/password login + registration were removed. App now uses Google-only auth in /auth.

export default function LoginScreen_Deprecated() {
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>Login is Google-only now.</Text>
      </View>
